...
verts, faces, normals, values = measure.marching_cubes(Data_not_rot_CT.data, spacing = Data_not_rot_PD.spacing , 0)
...
trimesh.exchange.export.export_mesh(mesh = mesh, file_obj = 'CT_2.ply')
